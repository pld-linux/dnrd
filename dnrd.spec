...
Domain Name Relay Daemon to buforujący, przekazujący serwer proxy DNS.
Jest najbardziej przydatny na firewallach dla VPN-ów lub połączeń
wdzwanianych, ale jest także przyjemnym buforem DNS dla małych sieci i
stacji roboczych.
